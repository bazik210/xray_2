...
static xray::console_commands::cc_bool s_animation_mob_is_positive_time_scale_command( "animation_mob_is_positive_time_scale", s_is_positive, false, xray::console_commands::command_type_engine_internal );
