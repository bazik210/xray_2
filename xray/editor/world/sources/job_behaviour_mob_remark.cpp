...
#include "pch.h"
#include "job_behaviour_mob_remark.h"
...
job_behaviour_mob_remark::job_behaviour_mob_remark( object_job^ parent_job )
	:job_behaviour_base(parent_job)
{
	...
	query_result_delegate* rq = XRAY_NEW_IMPL(g_allocator, query_result_delegate)(gcnew query_result_delegate::Delegate(this, &job_behaviour_mob_remark::on_behaviour_config_loaded), g_allocator);
	xray::resources::query_resource(
		"resources/brain_units/behaviours/mob_remark.behaviour",
...
void job_behaviour_mob_remark::load			( configs::lua_config_value const& config )
{
...
void job_behaviour_mob_remark::save( configs::lua_config_value& config )
{
...
void job_behaviour_mob_remark::get_properties	( wpf_property_container^ to_container )
{
	...
	prop_descriptor->dynamic_attributes->add( gcnew property_editors::attributes::external_editor_attribute(gcnew property_editors::attributes::external_editor_event_handler( this, &job_behaviour_mob_remark::on_select_animation ), false) );
 	to_container->properties->add(prop_descriptor);
 
	job_behaviour_base::get_properties( to_container );
}

void job_behaviour_mob_remark::on_select_animation	( wpf_controls::property_editors::property^ , Object^ )
{
...
void job_behaviour_mob_remark::on_behaviour_config_loaded( resources::queries_result& data )
{
...
System::Collections::Generic::List<System::String^>^  job_behaviour_mob_remark::get_available_events_list( )
{
