...
#ifndef OBJECT_MONSTER_NPC_H_INCLUDED
#define OBJECT_MONSTER_NPC_H_INCLUDED
...
public ref class animation_monster_name_ui_type_editor : public xray::editor::wpf_controls::property_editors::i_external_property_editor
{
public:
	virtual	void			run_editor	( xray::editor::wpf_controls::property_editors::property^ prop );
}; // ref class animation_monster_name_ui_type_editor

public ref class object_monster_npc : public object_base
{
	typedef object_base	super;

public:
					object_monster_npc	( tool_misc^ tool, render::scene_ptr const& scene );
	virtual			~object_monster_npc	( );
...
public:
	...
	*/
	...
	[DefaultValueAttribute( "" ), ReadOnlyAttribute( false )]
	[external_editor_attribute( animation_monster_name_ui_type_editor::typeid )]
...
}; // class object_monster_npc

} // namespace editor
} // namespace xray

#endif // #ifndef OBJECT_MONSTER_NPC_H_INCLUDED
