...
#ifndef JOB_BEHAVIOUR_MOB_REMARK_H_INCLUDED
#define JOB_BEHAVIOUR_MOB_REMARK_H_INCLUDED
...
public ref class job_behaviour_mob_remark : job_behaviour_base {

	typedef xray::editor::wpf_controls::property_container				wpf_property_container;

public:
	job_behaviour_mob_remark( object_job^ parent_job );

	~job_behaviour_mob_remark( )
	{
...
#endif // #ifndef JOB_BEHAVIOUR_MOB_REMARK_H_INCLUDED