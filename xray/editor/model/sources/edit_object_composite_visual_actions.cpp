...
void edit_object_composite_visual::register_actions( bool bregister )
{
	...
	//if(bregister)
	//{
	//	a												= gcnew	editor_base::action_delegate( action_name, gcnew editor_base::execute_delegate_managed(this, &edit_object_composite_visual::action_collision_panel_view) );
	//	a->set_checked( gcnew editor_base::checked_delegate_managed	( this, &edit_object_composite_visual::collision_panel_visible));
	//	input_engine->register_action					( a, "" );
	//	gui_binder->add_action_menu_item				( ide_menu_strip, action_name, "ViewMenuItem", 0);
	//}else
	//{
...
//void edit_object_composite_visual::action_collision_panel_view( )
//{
//	set_dock_panel_visible(  m_collision_panel );
//}
//
//bool edit_object_composite_visual::is_collision_edit_mode( )
//{
